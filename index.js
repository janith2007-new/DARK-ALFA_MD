...
async function startMiku() {
    ...
    console.log(color(figlet.textSync('DARK ALFA MD', {
        font: 'Pagga',
    ...
    console.log(color('\nHi iam Vihanga Theekshana Dark Alfa developer.\n\nThanks for using: Dark Alfa made by my Team VT.', 'aqua'))
    console.log(color('\nYou can follow me on GitHub: Vihanga-Theekshana\n\n', 'aqua'))
    ...
    const Miku = MikuConnect({
        ...
        browser: ['DARK ALFA MD', 'Safari', '1.0.0'],
        auth: state,
        version
    })
    ...
    Miku.ev.on('connection.update', async (update) => {
        ...
        status = connection;
        if (connection) {
            await console.info(`Dark Alfa MD Server Status => ${connection}`);
          }
